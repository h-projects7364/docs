...
{/* TODO: Screenshot - Lists page showing multiple lists with contact counts */}
<Frame caption="Screenshot: Lists page showing multiple lists with contact counts">
...
<Steps>
  ...
  <Step title="Create New List">
    ...
    {/* TODO: Screenshot - Create list button location */}
<Frame caption="Screenshot: Create list button location">
  <div className="bg-muted/50 rounded-lg p-8 text-center text-muted-foreground text-sm">
    [Screenshot placeholder]
  </div>
</Frame>
...
{/* TODO: Video - Adding contacts to a list from selection bar (15-20 seconds) */}
<Frame caption="Video: Adding contacts to a list from selection bar (15-20 seconds)">
  <div className="bg-muted/50 rounded-lg p-8 text-center text-muted-foreground text-sm">
    [Video placeholder]
  </div>
</Frame>
...
{/* TODO: Screenshot - List detail view showing filtered contacts */}
<Frame caption="Screenshot: List detail view showing filtered contacts">
  <div className="bg-muted/50 rounded-lg p-8 text-center text-muted-foreground text-sm">
    [Screenshot placeholder]
  </div>
</Frame>
